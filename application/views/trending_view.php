            ...
            <div class="d-flex justify-content-around w-100">
                ...
                <div class="d-flex flex-row" id="navBar">
                    ...
                    <div>
                        ...
                        <a class="nav-link  text-dark active" aria-current="page" href="#"> <i class="fas fa-fire"></i> &nbsp; Trending</a>
                    </div>
                    <div>
            ...
            <div class="content-container col-sm-11 shadow-sm">
                ...
                <?php foreach($projects as $row){ ?>
                    <div class="card mb-3 w-50 mx-auto">
                        <img src="<?=base_url('assets/images/Ok-bro.png')?>" class="card-img-top " alt="...">
                        <div class="d-flex flex-row">
                            <div class="card-body col-sm-8">
                                <h5 class="card-title"><?= $row->title?> - by <?= $row->username?></h5>
                                <p class="card-text">
                                    <?= $row->description?>
                                </p>
                            ...
                            <div class="col-sm-4 d-flex justify-content-end px-5">
                            <a href="trending/increment?post=<?=$row->postId?>"><i class="fa fa-heart fs-6 mt-5" aria-hidden="true"> <?=$row->likes?></i></a>
                            </div>
                        </div>
                    </div>
                        ...
                        <?php foreach ($trending as $row) { ?>
                            <li class="list-group-item border-0">
                                <span class="list-group-img">
                                    ...
                                    <div>
                                        <a class="username text-decoration-none text-dark fw-bold text-capitalize" href="project/?userId=<?=$row->userId?>"><?= $row->description ?></a>
