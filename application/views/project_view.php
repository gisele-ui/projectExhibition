    ...
    <nav class="navbar navbar-light  shadow-sm bg-body rounded ">
      <div class="d-flex justify-content-around w-100">
        ...
        <div class="d-flex flex-row" id="navBar">
          ...
          <div>
            <a class="nav-link text-dark" href="<?= base_url('').'dashboard'?>"><i class="fas fa-list-alt"></i> &nbsp; Dashboard</a>
          </div>
          <div>
            <a class="nav-link  text-dark " aria-current="page" href="<?= base_url('').'discover'?>"> <i class="fas fa-search-location "></i> &nbsp;Discover</a>

          </div>
          <div>

            <a class="nav-link  text-dark " href=""<?= base_url('').'trending'?>""> <i class="fas fa-fire"></i> &nbsp; Trending</a>
          </div>
          <div>
        ...
        <div class="buttons">
          <a href="<?= base_url('').'exhibit'?>" class="btn btn-info text-white">Exhibit</a>
          <div></div>
        </div>
      </div>
    </nav>
            ...
            <?php if($projects){
              foreach($projects as $row){ ?>
                <div class="col-6">
                  ...
                  <i class="fa fa-heart" aria-hidden="true"></i><?=$row->likes?>
                </div>
                  </div>
                </div>
              <?php }} else{ ?>  
                <div class="col-6">
                  <div class="p-3 border bg-light">No projects yet</div>
                </div>
            <?php }?>
          </div>
        </div>
